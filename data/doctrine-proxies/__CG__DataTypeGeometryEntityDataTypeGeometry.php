 ...
 */
class DataTypeGeometry extends \DataTypeGeometry\Entity\DataTypeGeometry implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DataTypeGeometry $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setResource(\Omeka\Entity\Resource $resource): \DataTypeGeometry\Entity\DataTypeGeometry
    {
     ...
     * {@inheritDoc}
     */
    public function setProperty(\Omeka\Entity\Property $property): \DataTypeGeometry\Entity\DataTypeGeometry
    {
     ...
     * {@inheritDoc}
     */
    public function setValue(\CrEOF\Spatial\PHP\Types\Geometry\GeometryInterface $value): \DataTypeGeometry\Entity\DataTypeGeometry
    {
